...
"SUBSCRIPTION_NAME, RESOURCE_GROUP_NAME,RESOURCE_NAME,TAGS" | Out-File $oFile -Append -Encoding ascii
...
Get-AzSubscription | ForEach-Object{
    ...
    Get-AzResourceGroup | ForEach-Object{
        ...
        Get-AzResource -ResourceGroupName $resourceGroupName | ForEach-Object{
            ...
            "$subscriptionId,$resourceGroupName,$resourceName,$tags" | Out-File $oFile -Append -Encoding ascii
        }
    }
}
